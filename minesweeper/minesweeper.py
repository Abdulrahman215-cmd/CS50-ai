...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence1 = Sentence(set_cells, count)
        self.knowledge.append(new_sentence1)

        new_inference = True
        while new_inference == True:
            new_inference = False
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    ...
                    if sentence1.cells.issubset(sentence2.cells):
                        s3_cells = sentence2.cells - sentence1.cells
                        s3_count = sentence2.count - sentence1.count
                        new_sentence2 = Sentence(s3_cells, s3_count)
    ...
    def make_safe_move(self):
        ...
        """
        for safe_moves in self.safes:
            if safe_moves not in self.moves_made:
                return safe_moves
        else:
            return None
